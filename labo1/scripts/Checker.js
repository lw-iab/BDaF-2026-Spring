...
// Required amounts:
//   TokenA: 110 * r tokens (in wei => 110e18 * RATE)
//   TokenB: 110 tokens   (in wei => 110e18)
const mintAmountA = parseEther("110") * RATE;
const mintAmountB = parseEther("110");
...
console.log("  TokenA:", formatEther(mintAmountA), "(= 110 * r)");
console.log("  TokenB:", formatEther(mintAmountB), "(= 110)");

// Send tokens to OnSiteChecker to spend tokens (for swap tests)
// address = 0xa6FF20737004fb2f632B6b9388C7731B871a201D
const txA = await tokenA.write.transfer(["0xa6FF20737004fb2f632B6b9388C7731B871a201D", mintAmountA], {
  account: deployer.account,
});
const txB = await tokenB.write.transfer(["0xa6FF20737004fb2f632B6b9388C7731B871a201D", mintAmountB], {
  account: deployer.account,
});
